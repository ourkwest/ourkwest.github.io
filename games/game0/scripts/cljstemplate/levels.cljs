...
(def tutorial-levels
  [(-> (mk-level
       ...
       (wire 4 [[[0 2]]])
       (wire 5 [[[0 2]]])
       (add-msg "Click on shapes to rotate them. Form a path.")
       )
   (-> (mk-level
         [0 0 PI]
         [4 [4 [0 []
       ...
       (wire 7 [[[3 1]] [[0 3]]])
       (wire 8 [[[0 2]] [[0 2]]])
       (add-msg "Sometimes you need to create more than one path.")
       )
   (-> (mk-level
         [0 0 PI]
         [4 [4 [0 []
       ...
       (wire 10 [[[1 3]] [[0 3]] [[0 3]]])
       (wire 11 [[[0 2]] [[0 2]] [[0 2]]])
       (add-msg "There may be as many as three paths.")
       )
   (-> (mk-level
         [0 0 (/ PI 2)]
         [4 [4 [0 []
       ...
       (wire 2  [[[0 2]] [[0 2]] [[0 2]]])
       (wire 18 [[[0 1]] [[0 2]] [[0 3]]])
       (add-msg "You don't always have to use all the pieces.")
       )])
