...
var count_19347 = (0);
while(true){
var m_19348 = cljs.core.async.impl.dispatch.tasks.pop();
if((m_19348 == null)){
} else {
m_19348.call(null);

if((count_19347 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE)){
var G__19349 = (count_19347 + (1));
count_19347 = G__19349;
continue;
} else {
}
}
