...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__4398__auto__,writer__4399__auto__,opt__4400__auto__){
return cljs.core._write(writer__4399__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var i_38442 = (0);
while(true){
if((i_38442 < arr.length)){
(arr[i_38442] = null);

var G__38443 = (i_38442 + (1));
i_38442 = G__38443;
continue;
} else {
}
...
var i_38455 = (self__.level + (1));
while(true){
if((i_38455 <= (new_level + (1)))){
(update[i_38455] = self__.header);

var G__38456 = (i_38455 + (1));
i_38455 = G__38456;
continue;
} else {
}
...
var i_38457 = (0);
while(true){
if((i_38457 <= self__.level)){
var links_38458 = (update[i_38457]).forward;
if(((links_38458[i_38457]) === x__$1)){
(links_38458[i_38457] = (x__$1.forward[i_38457]));

var G__38459 = (i_38457 + (1));
i_38457 = G__38459;
continue;
} else {
var G__38460 = (i_38457 + (1));
i_38457 = G__38460;
continue;
}
} else {
...
if(!((nx == null))){
var G__38462 = nx;
var G__38463 = (level__$1 - (1));
x = G__38462;
level__$1 = G__38463;
continue;
} else {
var G__38464 = x;
var G__38465 = (level__$1 - (1));
x = G__38464;
level__$1 = G__38465;
continue;
}
...
var G__38467 = nx;
var G__38468 = (level__$1 - (1));
x = G__38467;
level__$1 = G__38468;
continue;
} else {
var G__38469 = x;
var G__38470 = (level__$1 - (1));
x = G__38469;
level__$1 = G__38470;
continue;
}
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__4398__auto__,writer__4399__auto__,opt__4400__auto__){
return cljs.core._write(writer__4399__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
var or__3811__auto__ = (cljs.core.truth_((function (){var and__3799__auto__ = me;
...
cljs.core.async.impl.dispatch.queue_delay(((function (timeout_channel,or__3811__auto__,timeout__$1,me){
return (function (){
cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);

return timeout_channel.cljs$core$async$impl$protocols$Channel$close_BANG_$arity$1(null);
});})(timeout_channel,or__3811__auto__,timeout__$1,me))
,msecs);
