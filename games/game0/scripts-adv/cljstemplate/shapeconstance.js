...
cljstemplate.shapeconstance.square_pad = cljstemplate.shapeconstance.shape_pad(cljstemplate.shapeconstance.square_inner_radius);
...
cljstemplate.shapeconstance.hex_pad = cljstemplate.shapeconstance.shape_pad(cljstemplate.shapeconstance.hex_inner_radius);
cljstemplate.shapeconstance.oct_side = cljstemplate.shapeconstance.shape_side_length;
cljstemplate.shapeconstance.oct_radius = (function (){var G__17982 = (((cljstemplate.shapeconstance.oct_side / (2)) * (cljstemplate.shapeconstance.oct_side / (2))) + (((cljstemplate.shapeconstance.oct_side / (2)) + (cljstemplate.shapeconstance.oct_side / cljstemplate.constance.ROOT_TWO)) * ((cljstemplate.shapeconstance.oct_side / (2)) + (cljstemplate.shapeconstance.oct_side / cljstemplate.constance.ROOT_TWO))));
return (Math.sqrt.cljs$core$IFn$_invoke$arity$1 ? Math.sqrt.cljs$core$IFn$_invoke$arity$1(G__17982) : Math.sqrt.call(null,G__17982));
})();
cljstemplate.shapeconstance.oct_inner_radius = (cljstemplate.shapeconstance.oct_side * (((1) + cljstemplate.constance.ROOT_TWO) / (2)));
cljstemplate.shapeconstance.oct_pad = cljstemplate.shapeconstance.shape_pad(cljstemplate.shapeconstance.oct_inner_radius);
...
cljstemplate.shapeconstance.tri_pad = cljstemplate.shapeconstance.shape_pad(cljstemplate.shapeconstance.tri_inner_radius);
