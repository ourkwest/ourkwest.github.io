...
cljstemplate.shapeconstance.oct_radius = (function (){var G__29528 = (((cljstemplate.shapeconstance.oct_side / (2)) * (cljstemplate.shapeconstance.oct_side / (2))) + (((cljstemplate.shapeconstance.oct_side / (2)) + (cljstemplate.shapeconstance.oct_side / cljstemplate.constance.ROOT_TWO)) * ((cljstemplate.shapeconstance.oct_side / (2)) + (cljstemplate.shapeconstance.oct_side / cljstemplate.constance.ROOT_TWO))));
return (Math.sqrt.cljs$core$IFn$_invoke$arity$1 ? Math.sqrt.cljs$core$IFn$_invoke$arity$1(G__29528) : Math.sqrt.call(null,G__29528));
})();
